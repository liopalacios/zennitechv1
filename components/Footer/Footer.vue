  ...
  <footer
    ...
    <div class="container px-6 pt-6">
        ...
        <a
            href="#!"
            type="button"
            class="rounded-full bg-[#14e03a] p-3 uppercase leading-normal text-white shadow-dark-3 shadow-black/30 transition duration-150 ease-in-out hover:shadow-dark-1 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1 dark:text-white"
            data-twe-ripple-init
            data-twe-ripple-color="light">
            <span class="mx-auto [&>svg]:h-5 [&>svg]:w-5">
            <svg
        ...
        <a
            href="#!"
            type="button"
            class="rounded-full bg-[#de0d3e] p-3 uppercase leading-normal text-white shadow-dark-3 shadow-black/30 transition duration-150 ease-in-out hover:shadow-dark-1 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1 dark:text-white"
            data-twe-ripple-init
            data-twe-ripple-color="light">
            <span class="mx-auto [&>svg]:h-5 [&>svg]:w-5">
                <svg 
        ...
        <a
            href="#!"
            type="button"
            class="rounded-full bg-[#0c88cc] p-3 uppercase leading-normal text-white shadow-dark-3 shadow-black/30 transition duration-150 ease-in-out hover:shadow-dark-1 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1 dark:text-white"
            data-twe-ripple-init
            data-twe-ripple-color="light">
            <span class="mx-auto [&>svg]:h-5 [&>svg]:w-5">
                <svg 
    ...
    <div class="w-full bg-black/5 p-4 text-center">
        &copy; {{currentYear}} Copyright: <span style="font-weight: 700;">Zennitech</span>                     
    </div>
    </footer>
</template>
